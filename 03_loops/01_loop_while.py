...
print("\nEjercicio 5: Tabla de multiplicar")
contador = 1
multiplicar = int(input("Ingrese el numero a multiplicar: "))

while contador <= 10:
  print(f" El numero {multiplicar} x {contador} es = {multiplicar * contador}")
  contador += 1
...
print("\nEjercicio 6: Números primos hasta N")
primos = int(input("Ingrese un numero positivo: "))
numero = 2
