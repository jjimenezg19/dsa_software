...
if found_ia:
    print(f"He encontrado el patró IA en la posición : {found_ia.start()} y "
          f"termina en la posición : {found_ia.end()}")
else:
    print("No he encontrado el patrón IA")
...
for match in found:
    print(f"He encontrado la palabra {match.group()} y "
          f"Empieza en la posición {match.start()},"
          f"y termina en la posición {match.end()}")
